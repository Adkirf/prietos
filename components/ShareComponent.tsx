...
export function ShareComponent({ children, projectId, imageIndex }: ShareComponentProps) {
  ...
  useEffect(() => {
    ...
    const url = `${baseUrl}/${lang}/projects/${projectId}/${imageIndex}`
    setCurrentUrl(url)
    setShortUrl(`${baseUrl}/...`)
  }, [projectId, imageIndex, lang])
